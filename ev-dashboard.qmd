...
I found that the state with the highest proportion of renewable energy was North Dakota. Second to that was Maine. However, in general, the Midwest used the smallest proportion of renewable energy compared to their use of total energy. This shows that even though CA has the most EV registered vehicles, they don't use the highest proportion renewable energy compared to other states. So this could mean the electricity to charge the vehicles aren't that renewable.
