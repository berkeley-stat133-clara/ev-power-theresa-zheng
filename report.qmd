...
Chosen Question: How does the proportion of renewable energy used and total energy used compared between States from 2021-2023? What does the comparison of EV registrations and total energy look like? 
...
#change ev_reg so it has abbreviated states 
...
proportion_table <- left_join(new_2023, join_table) #shows the proportion of 
